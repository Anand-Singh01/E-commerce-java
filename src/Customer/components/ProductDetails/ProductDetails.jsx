        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    {/* Product info */}
                    <div className="lg:col-span-1 max-h-auto pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 max-w-2xl px-4 ">
                            ...
                            <Grid item xs={5}>
                                ...
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems={'center'} gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={20} className='bg-yellow-300' />
                                        </Grid>
                                    </Grid>
                                    <Grid container alignItems={'center'} gap={2}>
                                        <Grid item xs={2}>
